...
import 'package:buzz/search_filter_bottomsheet/search_filter_bottomsheet.dart';
...
class AppNavigationScreen extends StatelessWidget {
                              ...
                              child: Container(
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapChoosePaymentMethod(context);
                                            },
                                            child: Container(
                                                decoration:
                                                    AppDecoration.fillWhiteA700,
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapPaymentSuccessful(context);
                                            },
                                            child: Container(
                                                decoration:
                                                    AppDecoration.fillWhiteA700,
  ...
  onTapLetsYouIn(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.letSYouInScreen);
  }

  onTapSignUpBlank(BuildContext context) {
  ...
  onTapFillProfile(BuildContext context) {
  ...
  onTapForgotPasswordTypeOTP(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.forgotPasswordTypeOtpScreen);
  }

  onTapForgotPasswordFilledType(BuildContext context) {
  ...
  onTapResetPasswordSuccessful(BuildContext context) {
    showDialog(
        context: context,
  ...
  onTapRecentlyBooked(BuildContext context) {
  ...
  onTapMyBookmarks(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.myBookmarksScreen);
  }

  onTapBookmarkremoval(BuildContext context) {
  ...
  onTapSearchType(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.searchTypeScreen);
  }

  onTapSearchFilter(BuildContext context) {
    showModalBottomSheet(
        context: context,
  ...
  onTapFilterResult(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.filterResultScreen);
  }

  onTapHotelDetails(BuildContext context) {
  ...
  onTapRateHotel(BuildContext context) {
    showModalBottomSheet(
        context: context,
  ...
  onTapSelectdateGuest(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.selectDateGuestScreen);
  }

  onTapBookingName(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.bookingNameScreen);
  }

  onTapChoosePaymentMethod(BuildContext context) {
  ...
  onTapCardAdded(BuildContext context) {
  ...
  onTapPaymentSuccessful(BuildContext context) {
    showDialog(
        context: context,
        builder: (_) => const AlertDialog(
  ...
  onTapRefundMethod(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.refundMethodScreen);
  }

  onTapCancelationsuccessful(BuildContext context) {
    showDialog(
        context: context,
        builder: (_) => const AlertDialog(
